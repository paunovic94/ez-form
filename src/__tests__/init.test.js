...
describe('Init value in schema with second arg in useForm', () => {
    ...
    function TestForm(props) {
      ...
      return (
        <div>
          {formData.testSelectStringValue.render({
            selectOptions: [
              {value: 'test-select', label: 'Test Select Init 1'},
            ],
          })}
          {formData.testSelectObjectValue.render({
            selectOptions: [
              {value: 'test-select', label: 'Test Select Init 2'},
            ],
          })}
        </div>
      );
  ...
  test('Select - init with value that is not in selectOptions ', () => {
    function TestForm(props) {
      ...
      return (
        <div>
          ...
          {formData.testSelectMulti2.render({
            selectOptions: [
              {value: 'Exist in options', label: 'Exist in options'},
            ],
          })}
        </div>
      );
  ...
  test('Text Area', () => {
    function TestForm(props) {
      const {formData} = useForm({
        testAreaText: {
          ...
          defaultValue: 'test-area-text',
        },
        testAreaTextNoDefault: {
          formElement: formElements.textArea,
        },
      });
      ...
      return (
        <div>
          {formData.testAreaText.render()}
          {formData.testAreaTextNoDefault.render()}
        </div>
      );
    }
    ...
    expect(textareas[0].value).toBe('test-area-text');
